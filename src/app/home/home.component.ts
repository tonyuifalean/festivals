...
export class HomeComponent {
  ...
  private setMetaTags(): void {
    ...
    this.meta.updateTag({ property: 'og:title', content: 'Sighisoara Festival' });
    this.meta.updateTag({ property: 'og:description', content: "Your ultimate guide to the vibrant cultural celebrations of Sighisoara, Romania — medieval festivities, events, and local traditions." });
    this.meta.updateTag({ property: 'og:url', content: 'https://sighisoarafestival.com/home' });
